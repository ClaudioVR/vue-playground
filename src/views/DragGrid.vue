<template>
  <div>
    ...
    <v-btn v-if="itemsAreDraggable" class="mx-1" @click="itemsAreDraggable = false" color="primary" outlined>
      <v-icon left>mdi-lock</v-icon>
      Lock grid
    </v-btn>
    <v-btn v-if="!itemsAreDraggable" class="mx-1" @click="itemsAreDraggable = true" color="primary" outlined>
    ...
    <v-container class="grey lighten-4">
      ...
      >
        <grid-item class="pa-3" :class="item.color" v-for="item in layout"
          :x="item.x"
          :y="item.y"
          :w="item.w"
          :h="item.h"
  ...
  data() {
    return {
      ...
      layout: [
        ...
        {"x":8,"y":5,"w":4,"h":4,"i":"5", color: 'orange', name: 'Contractors'},
        {"x":4,"y":6,"w":8,"h":4,"i":"6", color: 'purple', name: 'Income'},
        {"x":0,"y":7,"w":4,"h":6,"i":"7", color: 'grey', name: 'Properties'},
        {"x":0,"y":8,"w":4,"h":3,"i":"8", color: 'teal lighten-2', name: 'Tenancy rent collection table'},
