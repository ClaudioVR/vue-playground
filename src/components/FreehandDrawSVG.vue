<template>
  <div class="draw">
    ...
    <div class="my-5">
      <v-btn depressed dark class="" @click="download()" color="blue">download</v-btn>
      <v-btn depressed class="mx-3" @click="clean()" color="success">Clear</v-btn>
      <v-btn depressed class="" @click="undoLine()" color="success">undo</v-btn>
    </div>
...
require('../assets/freehandDraw.css')
